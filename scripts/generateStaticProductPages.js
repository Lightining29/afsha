...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .img-card { background: ${p.slug === 'painless-facial-hair-remover' ? '#fce7f3' : (p.slug === 'electric-body-massager' ? '#fef3c7' : '#f1f5f9')}; border: 1px solid var(--border); border-radius: 36px; padding: 24px; position: relative; text-align: center; display: flex; align-items: center; justify-content: center; min-height: 360px; }
    .img-card img { width: 85%; max-height: 360px; object-fit: contain; filter: drop-shadow(0 20px 30px rgba(0, 0, 0, 0.22)) drop-shadow(0 8px 14px rgba(0, 0, 0, 0.12)); }
